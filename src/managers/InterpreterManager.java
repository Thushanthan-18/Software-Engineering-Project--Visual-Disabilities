...
public class InterpreterManager {
    ...
    private final String INTERPRETER_NOT_LOADED = "An interpreter could not be loaded, please check your settings point to the full path (example C:\\Program Files\\ghc7.03\\ghci.exe)";
