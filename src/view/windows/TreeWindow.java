...
public class TreeWindow {
    ...
    private final int treeChildProperties = 0;
    private final int treeChildFunctions = 1;
    private final int treeChildAlgebraicTypes = 2;
    private final int treeChildTypeSynonyms = 3;
...
//                                  ((ParsedTest)tests.get(i)).getName(),(ParsedTest) tests.get(i))));
    ...
    class MyRenderer extends DefaultTreeCellRenderer {
        ...
        protected boolean isParsedType(Object object) {
            return object.getClass().getName().equals("utils.parser.ParsedType");
        }

        protected boolean isParsedDatatype(Object object) {
            return object.getClass().getName().equals("utils.parser.ParsedDatatype");
        }

        protected boolean isParsedElement(Object object) {
            return object.getClass().getName().equals("utils.parser.ParsedFunction");
        }
    }
