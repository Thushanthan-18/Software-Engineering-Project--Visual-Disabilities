...
public class ConsoleWindow {
    ...
    private final JScrollPane jspMain = new JScrollPane();
    /*Object for JTextpane*/
    private final JTextPane jtaInterpreterOutput = new JTextPane();
    private final Document jtaIODoc = jtaInterpreterOutput.getDocument();
    private final SimpleAttributeSet errorText = new SimpleAttributeSet();
    private final SimpleAttributeSet infoText = new SimpleAttributeSet();
    private final SimpleAttributeSet normalText = new SimpleAttributeSet();
    private final SimpleAttributeSet inputText = new SimpleAttributeSet();
    private final SimpleAttributeSet promptText = new SimpleAttributeSet();
    ...
    private final java.util.ArrayList<String> history = new java.util.ArrayList<String>();
    ...
    private void jbInit() throws Exception {
        ...
        jtaInterpreterOutput.getActionMap().put("Evaluate", ActionManagerAccessibility
                .getInstance().getSendEvaluationAction());
        jtaInterpreterOutput.getInputMap(JComponent.WHEN_FOCUSED)
                .put(KeyStroke.getKeyStroke("UP"), "pressed Up");
        jtaInterpreterOutput.getActionMap().put("pressed Up", ActionManagerAccessibility
                .getInstance().getGoToPastConsoleHistory());
        jtaInterpreterOutput.getInputMap(JComponent.WHEN_FOCUSED)
                .put(KeyStroke.getKeyStroke("DOWN"), "pressed Down");
        jtaInterpreterOutput.getActionMap().put("pressed Down", ActionManagerAccessibility
        ...
        if (jtaIODoc instanceof javax.swing.text.AbstractDocument doc) {
