...
public class DefaultInputHandler extends InputHandler {
    ...
    public void addDefaultKeyBindings() {
        ...
        // Unfortunately the editor handles all key events itself.
        // So have to duplicate all global key shortcuts here.
        // Also two variants: one with Control, one with Meta (for Mac).

        // Program
        addKeyBinding("C+O", ActionManagerAccessibility.getInstance().getOpenFileAction());
        addKeyBinding("M+O", ActionManagerAccessibility.getInstance().getOpenFileAction());
        addKeyBinding("C+D", ActionManagerAccessibility.getInstance().getShowOptionsAction());
        addKeyBinding("M+D", ActionManagerAccessibility.getInstance().getShowOptionsAction());


        // Clipboard
        addKeyBinding("C+Z", ActionManagerAccessibility.getInstance().getUndoAction());
        addKeyBinding("M+Z", ActionManagerAccessibility.getInstance().getUndoAction());
        addKeyBinding("C+Y", ActionManagerAccessibility.getInstance().getRedoAction());
        addKeyBinding("M+Y", ActionManagerAccessibility.getInstance().getRedoAction());
        ...
        addKeyBinding("C+F", ActionManagerAccessibility.getInstance().getSearchAction());
        addKeyBinding("M+F", ActionManagerAccessibility.getInstance().getSearchAction());

        // Running

        addKeyBinding("C+L", ActionManagerAccessibility.getInstance().getCompileAction());
        addKeyBinding("M+L", ActionManagerAccessibility.getInstance().getCompileAction());

        addKeyBinding("C+I", ActionManagerAccessibility.getInstance().getInterruptAction());
        addKeyBinding("M+I", ActionManagerAccessibility.getInstance().getInterruptAction());

        addKeyBinding("C+T", ActionManagerAccessibility.getInstance().getTestAction());
        addKeyBinding("M+T", ActionManagerAccessibility.getInstance().getTestAction());
    }

    /**
     * Adds a key binding to this input handler. The key binding is a list of
     * white space separated key strokes of the form <i>[modifiers+]key </i> where
