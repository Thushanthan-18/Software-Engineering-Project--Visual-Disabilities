/*
 * Token.java - Generic token Copyright (C) 1998, 1999 Slava Pestov You may use
...
public class Token {
    ...
    /**
     * Keyword 1 token id. This can be used to mark a keyword. This should be used
     * for general language constructs.
     */
    public static final byte KEYWORD1 = 6;

    /**
     * Keyword 2 token id. This can be used to mark a keyword. This should be used
     * for preprocessor commands, or variables.
     */
    public static final byte KEYWORD2 = 7;

    /**
     * Keyword 3 token id. This can be used to mark a keyword. This should be used
     * for data types.
     */
    ...
    /**
     * Invalid token id. This can be used to mark invalid or incomplete tokens, so
     * the user can easily spot syntax errors.
     */
    ...
    public static final byte KEYWORD5 = 12;
    public static final byte KEYWORD6 = 13;
