...
/*
 * SyntaxDocument.java - Document that can be tokenized Copyright (C) 1999 Slava
...
public class SyntaxDocument extends PlainDocument {
    ...
    public static boolean getModifiedStatus() {
        return modified;
    }
     ...
     * into tokens. May throw an exception if this is not supported for this type
     * of document.
     *
    ...
    /**
     * Starts a compound edit that can be undone in one operation. Subclasses that
    ...
    protected void fireInsertUpdate(DocumentEvent evt) {
        if (tokenMarker != null) {
            ...
            if (ch != null) {
                tokenMarker.insertLines(ch.getIndex() + 1, ch.getChildrenAdded().length
