...
public class JEditTextArea extends JComponent {
    ...
    public JEditTextArea(TextAreaDefaults defaults) {
        ...
        // Disable horizontal scroll by default
        ...
        document.addUndoableEditListener(new HEATUndoableEditListener());
     ...
     * of lines in the document changes, or when the size of the text are changes.
     */
     ...
     *
     * @param enabled State of horiztonal scroll bar
     */
    ...
    public boolean scrollTo(int line, int offset) {
        ...
        if (x < painter.getLeftBorder()) {
            newHorizontalOffset = Math.min(0, horizontalOffset
                    - (x - painter.getLeftBorder()) + width + 5);
    ...
    public int _offsetToX(int line, int offset) {
        ...
        int x = horizontalOffset + painter.getLeftBorder();
        ...
        /*
         * If syntax coloring is enabled, we have to do this because tokens can vary
         * in width
         */
        else {
            Token tokens;
            ...
            for (; ; ) {
                ...
                if (offset + segmentOffset < lineSegment.offset + length) {
                    ...
                    return x
                            + Utilities.getTabbedTextWidth(lineSegment, fm, x, painter, 0);
                } else {
    ...
    public int xToOffset(int line, int x) {
        ...
        int width = horizontalOffset + painter.getLeftBorder();
        ...
        try {
            if (rectSelect) {
                ...
                for (int i = selectionStartLine; i <= selectionEndLine; i++) {
                    ...
                    document
                            .remove(rectStart, Math.min(lineEnd - rectStart, end - start));
                    ...
                    document.insertString(rectStart, selectedText.substring(lastNewline,
                            currNewline), null);
    ...
    public void processKeyEvent(KeyEvent evt) {
        if (inputHandler == null || !wm.getEditorWindow().isEnabled()) {
        ...
        switch (evt.getID()) {
            ...
            case KeyEvent.KEY_PRESSED:
                ...
                //refresh parsermanager on ENTER and SPACE
                if (evt.getKeyCode() == 10 || evt.getKeyCode() == 32) ParserManager.refresh();
    ...
    class ScrollLayout implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            ...
            bottom.setBounds(ileft, itop + centerHeight, size.width - rightWidth
                    - ileft - iright, bottomHeight);
        }
    ...
    class MouseHandler extends MouseAdapter {
        ...
        private void doDoubleClick(MouseEvent evt, int line, int offset, int dot)
            ...
            try {
                int bracket = TextUtilities.findMatchingBracket(document, Math.max(0,
                        dot - 1));
                if (bracket != -1) {
             ...
             * TextUtilities.findWordEnd(lineText,offset,noWordSep); int lineStart =
             * getLineStartOffset(line); select(lineStart + wordStart,lineStart +
             * wordEnd);
             */
        }
    ...
    private class HEATUndoableEditListener
